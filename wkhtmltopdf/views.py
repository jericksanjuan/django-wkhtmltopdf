...
class PDFTemplateMixin(object):
    ...
    def __init__(self, *args, **kwargs):
        super(PDFTemplateMixin, self).__init__(*args, **kwargs)
    ...
    def get(self, request, *args, **kwargs):
        if request.GET.get('as', '') == 'pdf':
            self.response_class = self.pdf_response_class
    ...
    def render_to_response(self, context, **response_kwargs):
        ...
        if issubclass(self.response_class, PDFTemplateResponse):
            ...
            return super(PDFTemplateMixin, self).render_to_response(
                context=context,
            )
